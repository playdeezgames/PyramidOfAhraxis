...
GAMELOOP.
       ...
       DISPLAY "AVAILABLE COMMAND: " WITH NO ADVANCING 
       IF CANGONORTH THEN 
           DISPLAY "(GO [N]ORTH) " WITH NO ADVANCING
       END-IF
       IF CANGOEAST THEN 
           DISPLAY "(GO [E]AST) " WITH NO ADVANCING
       END-IF
       IF CANGOSOUTH THEN 
           DISPLAY "(GO [S]OUTH) " WITH NO ADVANCING
       END-IF
       IF CANGOWEST THEN 
           DISPLAY "(GO [W]EST) " WITH NO ADVANCING
       END-IF
       DISPLAY "(GAME [M]ENU) " WITH NO ADVANCING
       DISPLAY SPACE
       ACCEPT COMMAND
       EVALUATE COMMAND
           WHEN "m" WHEN "M"
...
DESCRIBEROOM1.
       DISPLAY "YER IN A TWENTY FIVE FOOT BY FIFTEEN FOOD CHAMBER."
